...
function Editor(props) {
    ...
    setActiveSectionKey]=useState(Object.keys(sections)[0]);
    const [activeInformation,
    setActiveInformation]=useState(information[sections[Object.keys(sections)[0]]]);
    const [activeDetailIndex,
    setActiveDetailIndex]=useState(0);
    const [sectionTitle,
    setSectionTitle]=useState(sections[Object.keys(sections)[0]]);
...
const workExpBody=(<div className= {
        styles.detail
    }
...
> <InputControl label="Certificate Link"
...
> <label>Enter work description</label> <InputControl placeholder="Line 1"

value= {
    values.points ? values.points[0] : ""
}

onChange= {
    (event)=> handlePointUpdate(event.target.value, 0)
}
...
onChange= {
    (event)=> handlePointUpdate(event.target.value, 1)
}
...
onChange= {
    (event)=> handlePointUpdate(event.target.value, 2)
}

/> </div> </div>);
const projectBody=(<div className= {
        styles.detail
    }
...
/> </div> <InputControl label="Overview"
value= {
    values.overview
}
...
> <label>Enter project description</label> <InputControl placeholder="Line 1"
...
value= {
    values.points ? values.points[3] : ""
}

onChange= {
    (event)=> handlePointUpdate(event.target.value, 3)
}

/> </div> </div>);
const educationBody=(<div className= {
        styles.detail
    }
...
/> </div> <InputControl label="College/School Name"
value= {
    values.college
}
...
/> </div> </div>);
const basicInfoBody=(<div className= {
        styles.detail
    }
    ...
    placeholder="Enter your full name eg. Krishna"
...
> <InputControl label="Linkedin Link"
...
/> </div> </div>);
const achievementsBody=(<div className= {
        styles.detail
    }
    ...
    > <label>List your achievements</label> <InputControl placeholder="Line 1"
    ...
    /> </div> </div>);
const summaryBody=(<div className= {
        styles.detail
    }
...
/> </div>);
const otherBody=(<div className= {
        styles.detail
    }

    > <InputControl label="Other"
...
return (<div className= {
    ...
    > {
        Object.keys(sections)?.map((key)=> (<div className= {
                    `$ {
                        styles.section
                    }
    ...
    onChange= {
        (event)=> setSectionTitle(event.target.value)
    }
    ...
    > {
        activeInformation?.details ? activeInformation?.details?.map((item, index)=> (<div className= {
                    `$ {
                        styles.chip
                    }
        ...
        {
        activeInformation?.details && activeInformation?.details?.length > 0 ? (<div className= {
                styles.new
            }
